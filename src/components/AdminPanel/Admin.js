...
const Admin = () => {
  ...
  useEffect(() => {
    fetch(
      `https://restaurant-delivery-app-10419-default-rtdb.firebaseio.com/${adminMail}.json`,
      {
        method: "GET",
        headers: {
    ...
    <div style={{ position: "relative", width: "100%", height: "100vh" }}>
      ...
      >
        <div style={{ paddingLeft: "60px", paddingTop: "15px" }}>
          <Image
            style={{ width: "7.5%" }}
            roundedCircle
            src="https://i.pinimg.com/736x/b0/5f/8d/b05f8d2080e9f42c50eaf81f1170d9cd.jpg"
          />
        </div>
        <div
          style={{
      ...
      {showItemForm && (
        <AddItemsForm
          ...
          closeForm={closeItemformHandler}
        />
      )}
      <div
        style={{
      ...
      <Image
        style={{ width: "100%", height: "700vh" }}
        src="https://i.pinimg.com/736x/db/e8/fa/dbe8fac33fce30410d98d47740cd150c.jpg"
      />
    </div>
  );
};
