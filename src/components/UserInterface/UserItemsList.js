    ...
    return (
        <Container style={{ padding: "10px" }}>
            ...
            <Row>
                {starters.map((item) => (
                    <Col xs={3} key={item.id} style={{ marginBottom: '-5%', padding: "10px" }}>
                        <NavLink style={{ textDecoration: 'none', color: 'white' }} to={`/users/starters/${item.name}`}>
            ...
            <Row>
                {mainCourse.map((item) => (
                    <Col xs={3} key={item.id} style={{ marginBottom: '-5%', padding: "10px" }}>
                        <NavLink style={{ textDecoration: 'none', color: 'white' }} to={`/users/maincourse/${item.name}`}>
                            <div style={{ textAlign: 'center', paddingBottom: '10px' }}>{item.name}</div>
                            <Image style={{ width: "90%", height: "60%" }} roundedCircle src={item.image} />
                        </NavLink>
                    </Col>
            ...
            <Row>
                {desserts.map((item) => (
                    <Col xs={3} key={item.id} style={{ marginBottom: '-5%', padding: "10px" }}>
                        <NavLink style={{ textDecoration: 'none', color: 'white' }} to={`/users/dessert/${item.name}`}>
                            <div style={{ textAlign: 'center', paddingBottom: '10px' }}>{item.name}</div>
                            <Image style={{ width: "90%", height: "60%" }} roundedCircle src={item.image} />
                        </NavLink>
                    </Col>
